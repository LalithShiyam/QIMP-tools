...
Sample images from the axial and coronal views: on the left side the low dose PET image, in the middle the output of the 3D GAN and on the right side the high dose PET image
