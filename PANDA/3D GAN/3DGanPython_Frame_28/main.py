...
if __name__ == "__main__":
    ...
    parser.add_argument("--gen_weights", type=str, default='./History/weights/gen_weights_frame_28.h5', help='generator weights to load')
    ...
    parser.add_argument("--mini_patch", action='store_true', default=False, help=' If True, discriminator and DCgan will be trained with subpatches of the generator input')
