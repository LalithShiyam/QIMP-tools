...
parser.add_argument("--new_resolution", type=float, default=(0.520833*1.4, 0.520833*1.4, 1*1.4), help='New resolution')
...
parser.add_argument("--drop_ratio", type=float, nargs=1, default=0.2, help="Probability to drop a cropped area if the label is empty. All empty patches will be dropped for 0 and accept all cropped patches if set to 1")
...
train_gen = NifitDataSet(train_list, transforms=trainTransforms, train=True)
